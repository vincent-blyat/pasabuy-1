  ...
  <div class="desktopVersion">
    ...
    >
      ...
      <div class="mt-20 shadow-md relative" style="min-width: 270px">
        <div
          class="relative flex justify-items-center md:justify-items-center pt-1 shadow"
        >
          <button
        ...
        <div class="flex justify-center relative py-1 pt-2">
          <input
            type="text"
            class="h-8 w-11/12 pl-4 border focus:outline-none focus:ring-1 focus:ring-gray-300 rounded-full"
            placeholder="Search"
          />
          <button
            class="absolute right-8 pt-1 focus:outline-none hover:text-red-700"
            @click="searchInputD"
            type="button"
          >
      ...
      <!---rightCorner-->
      <div
        class="vs:w-full mt-20 w-2/5 md:w-3/5 shadow-md relative"
        style="min-width: 400"
      >
        <div
...
<!--  ml-4 mr-10 p-3 bg-gray-100 text-sm rounded-lg -->   
       <!--  
        ...
        >
          <div
            v-if="attachtoggle"
            class="ml-3 h-12 flex flex-cols justify-between items-center"
          >
            <button
              id="add"
              class="rounded-full h-8 w-8 mr-2 pt-1 border-solid border-2 border-red-700 hover:text-red-700"
            >
            ...
            <button
              class="rounded-full h-8 w-8 pt-1 border-solid border-2 border-red-700 hover:text-red-700"
            >
        ...
        <div class="vs:w-full mt-16 shadow-md relative" style="min-width: 400">
          ...
          >
            ...
            <div>
              <div v-if="toggle">
                <button
                  class="absolute right-0 mt-7 px-2 h-9 w-24 rounded bg-gray-100 border-solid border-2 border-gray-300 hover:text-red-700"
                >
              ...
              <button
                @click="threedots"
                class="absolute right-4 pt-1 focus:outline-none hover:text-red-700"
                type="button"
              >
