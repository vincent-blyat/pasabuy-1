<template>
      <div v-on:click.self="close2" class="bg-black bg-opacity-25 fixed inset-0 flex justify-center items-center ssm:px-2 vs:px-2 vs:w-full">
       <div class="inline-flex flex-col space-y-2 bg-white shadow rounded-xl h-auto w-550 ssm:w-full vs:w-full">
  ...
  <div class="flex flex-col mt-1 vs:mt-1 ssm:px-2 vs:mt-0 justify-center items-center vs:px-2">
      ...
      <div class="flex flex-row ssm:flex-col ssm:space-x-0 ssm:space-y-2 se:space-x-1 space-x-4 w-full justify-center">
         <div class="flex flex-row space-x-2">
             ...
             <div class="flex items-center justify-start ssm:px-2 ssm:h-auto ssm:w-full vs:w-full w-52 h-11 vs:h-12 px-4 vs:px-2 bg-gray-100 rounded-xl">
              <div class="flex flex-col items-start justify-start w-full h-full py-1.5 rounded-2xl">
                  ...
                  <span>
                    <input type="text" id="input_name" v-model="delivery_info.delivery_area" class="ssm:text-xs block bg-gray-100 text-sm focus:outline-none leading-7 text-gray-900 w-44 vs:w-full h-auto">            
                   </span>
              </div>
          </div>
         </div>
         ...
         <div class="flex flex-row space-x-2">
             ...
             <div class="flex items-center justify-start w-52 ssm:px-2 ssm:h-auto ssm:w-full vs:w-full h-11 vs:h-12 px-4 vs:px-2 bg-gray-100 rounded-xl">
              <div class="flex flex-col w-full h-full py-1.5 rounded-2xl">
                  ...
                  <span>
                    <input type="text" id="input_name" v-model="delivery_info.shopping_place" class="ssm:text-xs block bg-gray-100 text-sm focus:outline-none leading-7 text-gray-900 w-44 vs:w-full h-auto">            
                   </span>
              </div>
          </div>
         </div>
        ...
        <div class="flex flex-row space-x-2">
            ...
            <div class="flex items-center justify-start ssm:px-2 ssm:h-auto ssm:w-full vs:w-full w-52 h-11 vs:h-12 px-4 vs:px-2 bg-gray-100 rounded-xl">
             <div class="flex flex-col items-start justify-start vs:w-full h-full py-1.5 rounded-2xl">
                 ...
                 <span>
                    <input type="text" id="input_name" v-model="delivery_info.schedule" class="ssm:text-xs block bg-gray-100 text-sm focus:outline-none leading-7 text-gray-900 w-44 vs:w-full h-auto">            
                   </span>
             </div>
         </div>
        </div>
        ...
        <div class="flex flex-row space-x-2">
         ...
         <div class="inline-flex items-center justify-start w-52 ssm:px-2 ssm:h-auto ssm:w-full vs:w-full h-11 vs:h-12 px-4 vs:px-2 bg-gray-100 rounded-xl">
          <div class="inline-flex flex-col items-start justify-start vs:w-full h-full py-1.5 rounded-2xl">
              ...
              <span>
                <input type="text" id="input_name" v-model="delivery_info.payment_method" class="ssm:text-xs  block bg-gray-100 text-sm focus:outline-none leading-7 text-gray-900 w-44 vs:w-full h-auto">            
                </span>
          </div>
      </div>
     </div>
    ...
    <!--Post button-->
    <div class="justify-center flex mt-3 pb-3 ssm:px-2 vs:px-2">
