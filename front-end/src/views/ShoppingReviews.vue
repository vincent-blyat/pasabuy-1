...
<div class="bg-gray-100 pt-6 font-nunito">
  <!--profile review-->
  <div class="flex items-center sm:flex-col vs:flex-col md:flex-col md:h-auto vs:h-auto sm:h-auto vs:pb-6 sm:pb-6 md:pb-6 w-full justify-center  vs:space-x-0 sm:space-x-0 space-x-10">

  <!--Rating-->
    <div class="flex flex-col vs:h-auto sm:h-auto md:h-auto h-screen">
    <div class="flex ">
...
<!--user post comments about reviews-->
  <div class="flex flex-col vs:mt-6 sm:mt-6 sm:h-auto md:mt-6 md:h-auto h-screen vs:w-full min-w-0 px-2 sm:w-full vs:h-auto">

    <!--post 1-->
    <div class="flex vs:w-full sm:w-full">
      <div class="inline-flex items-start justify-start p-6 vs:p-4 bg-white shadow rounded-xl h-auto w-608 vs:w-full sm:w-full ">     
        <div class="flex flex-col ">
        ...
        <div class="flex items-start justify-start px-6 py-4  bg-gray-100 rounded-xl h-auto mt-3 w-99 vs:w-full sm:w-full">
  ...
  <!--post 2-->
  <div class="flex py-6 vs:w-full sm:w-full">
