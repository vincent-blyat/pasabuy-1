<template>
  ...
  <div
    class="flex justify-center self-center font-nunito mb-11 mt-28 2xl:mt-4 xl:mt-4 lg:mt-4 w-full"
  >
    <div
      class="w-full px-3 flex flex-col justify-center self-center gap-y-5 space-y-4 2xl:w-6/12 lg:w-6/12 xl:w-6/12 md:w-8/12 sm:w-10/12"
    >
