  ...
  >
    ...
    <div id="personal_info" class="text-sm gap-x-10 pt-8 w-full">
      <form id="myForm" class=" ">
        <div class="flex flex-col items-center gap-y-3 justify-center">
          <img
            src="img/yami.jpg"
            class="w-16 h-16 rounded-full ring-2 ring-gray-500"
          />
          <label
            for="profile_image"
            class="font-extrabold cursor-pointer text-blue-800"
            >Change Profile Photo</label
          >
        </div>
        <input id="profile_image" type="file" class="hidden" />
        <div
          class="text-sm w-full gap-x-10 pt-8 space-y-8 xl:w-7/12 2xl:w-9/12 lg:w-8/12"
        >
    ...
    <div v-if="toggle" class="fixed items-center inset-0 overflow-y-auto">
      <div class="flex mt-4 w-full p-3 items-center justify-center py-20">
        <div
          class="bg-white ring-1 ring-gray-300 p-5 w-full rounded-md 2xl:w-6/12 lg:w-6/12 xl:w-6/12 md:w-8/12 sm:w-10/12 shadow-2xl h-auto"
        >
          ...
          <div class="2xl:px-28 xl:px-28 lg:px-28 md:px-10">
            <div class="relative grid grid-cols-2 gap-y-4">
              ...
              <input
                ...
                type="text"
                :value="personal.name"
                class="pl-2 bg-transparent border-2 border-gray-400"
              />
              <span>Middlename:</span>
              <input
                type="text"
                :value="personal.midname"
                class="pl-2 bg-transparent border-2 border-gray-400"
              />
              <span>Lastname: </span>
              <input
              ...
              <span>Birthday:</span>
              <input
                class="pl-2 w-full bg-transparent border-2 border-gray-400"
            ...
            <div class="flex justify-end mt-4 space-x-4">
              <button
                @click="toggle = false"
                class="px-3 bg-red-700 text-white rounded-2xl"
              >
                Cancel
              </button>
              <button
                @click="toggle = false"
                class="px-5 shadow-xl ring-1 ring-gray-300 bg-white text-red-700 rounded-2xl"
              >
                Save
              </button>
            </div>
