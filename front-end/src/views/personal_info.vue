       ...
       <div v-if="toggle" class="fixed inset-0 h-max bg-white bg-opacity-75"></div>
        ...
        ">
          ...
          <div class=" 2xl:px-28 xl:px-28 lg:px-28 md:px-10">
            ...
            ">
                <span>Firstname:</span> <input id="f_name"   type="text" :v-model="personal.name" class=" pl-2 bg-transparent border-2 border-gray-400"/>
                ...
                <div class=" space-x-4">
                  ...
                  <span><input type="radio" id="male" name="gender" v-model="personal.gender"/></span>
                  <label for="male">Male</label>
                  </span>
                  <span class="space-x-2">
                  <span><input type="radio"  id="female" name="gender" v-model="personal.gender"/></span>
