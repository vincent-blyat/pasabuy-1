<template>
   <div v-if = "isVisible">
      <div v-on:click.self="close1" class="bg-black bg-opacity-25 fixed inset-0 flex justify-center items-center">
       <div class="inline-flex flex-col space-y-2 bg-white shadow rounded-xl h-auto w-550 vs:w-96.7">
          <div class="flex flex-col  mt-4">
              ...
              <h1 class="items-center justify-center vs:ml-0 ml-12 pb-4 text-gray-900 leading-normal pl-24 text-2xl font-bold text-center">
                  Edit Shopping Offer
                  <button @click.prevent="close1" class=" vs:ml-10 ml-20 focus:outline-none text-sm mb-1 leading-none text-indigo-900">
                  Close
                  </button>
                </h1>
              <!--end-->
      ...
      <div class="flex flex-row space-x-4 justify-center">
         <div class="flex flex-row space-x-2">
             ...
             <div class="flex items-center justify-start vs:w-44 w-52 h-11 vs:h-12 pl-4 bg-gray-100 rounded-xl">
              <div class="flex flex-col items-start justify-start w-52 h-full py-1.5 rounded-2xl">
         ...
         <div class="inline-flex items-center justify-start xl:w-52 vs:w-44 h-11 vs:h-12 pl-4  bg-gray-100 rounded-xl">
          <div class="inline-flex flex-col items-start justify-start h-full py-1.5 rounded-2xl">
              <p class="text-xs font-semibold leading-none text-gray-500">Public Transit</p>
               <span>
                <input type="text" id="input_name" v-model="delivery_info.public_transit" class="block bg-gray-100 text-sm focus:outline-none leading-7 text-gray-900 w-44 vs:w-28.5 h-auto">            
                </span>
          </div>
      </div>
     </div>
        ...
        <div class="flex flex-row space-x-2">
            ...
            <div class="flex items-center justify-start vs:w-44 w-52 h-11 vs:h-12 pl-4 bg-gray-100 rounded-xl">
             <div class="flex flex-col items-start justify-start h-full py-1.5 rounded-2xl">
                 ...
                 <span>
                 <input type="text" id="input_name" v-model="delivery_info.capacity" class="block bg-gray-100 text-sm focus:outline-none leading-7 text-gray-900 w-44 vs:w-28.5 h-auto">            
                 </span>
             </div>
         </div>
        </div>
         ...
         <div class="inline-flex items-center justify-start xl:w-52 vs:w-44 h-11 vs:h-12 pl-4 bg-gray-100 rounded-xl">
          <div class="inline-flex flex-col items-start justify-start h-full py-1.5 rounded-2xl">
              <p class="text-xs font-semibold leading-none text-gray-500">Payment Method</p>
               <span>
                <input type="text" id="input_name" v-model="delivery_info.payment_method" class="block bg-gray-100 focus:outline-none text-sm leading-7 text-gray-900 w-44 vs:w-28.5 h-auto">            
                </span>
          </div>
      </div>
     </div>
